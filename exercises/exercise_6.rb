...
#       the `@store#` instance variables that you defined in previous exercises. Create a bunch under `@store1`
...
@store1.employees.create(first_name: 'Tim', last_name: 'Johns', hourly_rate: 40)
@store1.employees.create(first_name: 'Robert', last_name: 'Jackiewicz', hourly_rate: 45)


@store2.employees.create(first_name: 'Liam', last_name: 'Williams', hourly_rate: 14)
@store2.employees.create(first_name: 'Jonathan', last_name: 'Wallace', hourly_rate: 34)
@store2.employees.create(first_name: 'Adam', last_name: 'Goldberg', hourly_rate: 52)
@store2.employees.create(first_name: 'Rachel', last_name: 'Greenspan', hourly_rate: 51)